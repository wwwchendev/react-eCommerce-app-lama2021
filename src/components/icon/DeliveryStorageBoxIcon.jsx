const DeliveryStorageBoxIcon = ({ $color = 'currentColor' }) => {
  return (
    <svg viewBox='0 0 32 32' xmlns='http://www.w3.org/2000/svg' fill={$color}>
      ...
      <g id='SVGRepo_iconCarrier'>
        <g data-name='21. Pallet' id='_21._Pallet'>
          <path
            fill='#6e6e6e'
            d='M7,5h4a0,0,0,0,1,0,0V8a1,1,0,0,1-1,1H8A1,1,0,0,1,7,8V5A0,0,0,0,1,7,5Z'
          ></path>
          <path
            fill='#6e6e6e'
            d='M21,5h4a0,0,0,0,1,0,0V8a1,1,0,0,1-1,1H22a1,1,0,0,1-1-1V5A0,0,0,0,1,21,5Z'
          ></path>
          <path
            fill='#3b3b3b'
          ...
          <path
            fill='#3b3b3b'
            d='M8,16H6a1,1,0,0,1,0-2H8a1,1,0,0,1,0,2Z'
          ></path>
          <path
            fill='#3b3b3b'
            d='M22,16H20a1,1,0,0,1,0-2h2a1,1,0,0,1,0,2Z'
          ></path>
        </g>
      </g>
    </svg>
...
export default DeliveryStorageBoxIcon
