const DeliveryReturnBoxIcon = ({ $color = "currentColor" }) => {
	return (
		<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill={$color}>
			...
			<g id="SVGRepo_iconCarrier">
				<g data-name="9. Return" id="_9._Return">
					...
					></path>
					<path className="cls-2" fill="#3b3b3b" d="M15,19H14a1,1,0,0,1,0-2h1a1,1,0,0,1,0,2Z"></path>
					<path
						className="cls-2"
						fill="#3b3b3b"
...
export default DeliveryReturnBoxIcon 