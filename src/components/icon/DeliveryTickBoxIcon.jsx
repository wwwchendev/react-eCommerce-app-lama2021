		...
		<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill={$color}>
			...
			<g id="SVGRepo_iconCarrier">
				<g data-name="5. Box Check" id="_5._Box_Check">
					...
					></path>
					<circle className="cls-1" fill="#aaaaaa" cx="23" cy="23" r="5"></circle>
					<path
						className="cls-2"
						fill="#3b3b3b"
...
export default DeliveryTickBoxIcon 