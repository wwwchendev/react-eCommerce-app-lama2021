      ...
      >
        ...
        <g id='SVGRepo_iconCarrier'>
          ...
          <path
            fillRule='evenodd'
            clipRule='evenodd'
            d='M10.692 17.95C10.6909 18.5286 10.2212 18.9968 9.64268 18.996C9.06414 18.9953 8.59564 18.5259 8.59601 17.9474C8.59638 17.3688 9.06547 16.9 9.64401 16.9C9.92222 16.9003 10.1889 17.0111 10.3855 17.208C10.582 17.4049 10.6923 17.6718 10.692 17.95V17.95Z'
            stroke={$color}
            strokeWidth='1.5'
            strokeLinecap='round'
            strokeLinejoin='round'
          ...
          <path
            fillRule='evenodd'
            clipRule='evenodd'
            d='M16.281 17.95C16.2799 18.5286 15.8102 18.9968 15.2317 18.996C14.6531 18.9953 14.1846 18.5259 14.185 17.9474C14.1854 17.3688 14.6545 16.9 15.233 16.9C15.5112 16.9003 15.7779 17.0111 15.9745 17.208C16.171 17.4049 16.2813 17.6718 16.281 17.95V17.95Z'
            stroke={$color}
            strokeWidth='1.5'
            strokeLinecap='round'
            strokeLinejoin='round'
          ...
          <path
            fillRule='evenodd'
            clipRule='evenodd'
            d='M20.1 7.80005H9.99303L9.29303 13.4C9.29303 14.1732 9.91983 14.8 10.693 14.8L18.5 14C18.9917 13.9998 19.4472 13.7417 19.7 13.32L21.3 9.92005C21.5593 9.48764 21.5661 8.9492 21.3177 8.51041C21.0694 8.07163 20.6042 7.80029 20.1 7.80005Z'
            stroke={$color}
            strokeWidth='1.5'
            strokeLinecap='round'
            strokeLinejoin='round'
