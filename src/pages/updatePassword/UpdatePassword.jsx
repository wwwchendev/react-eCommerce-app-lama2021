    ...
    if (password && newPassword && checkedPassword) {
      if (newPassword !== checkedPassword) {
        ...
        const updatePassword = async () => {
          ...
          try {
            const response = await customAxios.patch(`${import.meta.env.VITE_APIURL}/auth/updatePassword/user`, updatedData, { headers: { Authorization: `Bearer ${TOKEN}` } });
            setShowConfirm(true)
                  ...
                  <Form>
                    ...
                    <Field>
                      <InputWrapper $offsetX={"5rem"}>
                        ...
                        <Input type='password' name='password' onChange={handleChange} $autoComplete='current-password' placeholder='原本的密碼' id="舊密碼" $border={promptMessage?.password} />
                    ...
                    <Field>
                      <InputWrapper $offsetX={"5rem"}>
                        ...
                        <Input type='password' name='newPassword' onChange={handleChange} $autoComplete='new-password' placeholder='新的密碼' id="新密碼" $border={promptMessage?.newPassword} />
                    ...
                    <Field>
                      <InputWrapper $offsetX={"5rem"}>
                        ...
                        <Input type='password' name='checkedPassword' onChange={handleChange} $autoComplete='new-password' placeholder='輸入新密碼進行檢核(必要)' id="再次確認密碼" $border={promptMessage?.checkedPassword} />
