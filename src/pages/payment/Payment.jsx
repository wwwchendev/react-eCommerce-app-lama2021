                            ...
                            <Reminder>
                              ...
                              <div>
                                ...
                                <p>
                                  訂單編號:{' '}
                                  <Link
                                    to={`/orders/${orderData?.orderNumber}`}
                                    target='_blank'
                                  >
                                    {orderData?.orderNumber}
                                  </Link>{' '}
                                  , 應付金額:<span>NT$ {orderData?.total}</span>
                                </p>

                                <p>
                                  請在 <span>{expiredTimeCountDown} </span>
                                  前完成付款，以確保訂單順利處理。
                                </p>
                                <p>
                                  提醒：如超過時間繳費，系統將自動取消逾期訂單
                                </p>
                              </div>
                            </Reminder>
                            <OnlinePayment>
                              ...
                              <PayButton type='button' onClick={handleSubmit}>
                                立即付款
                              </PayButton>
                            </OnlinePayment>
                          </>
                            ...
                            <Reminder>
                              ...
                              <div>
                                ...
                                <p>
                                  ...
                                  , 訂單金額:<span>NT$ {orderData?.total}</span>{' '}
                                </p>
                                <p>
                                  由於未在指定時間內完成付款，訂單{' '}
                                  <b>{orderData?.orderNumber}</b> 已取消。
                                </p>
                                <p>如需重新訂購，敬請再次下單。</p>
                              </div>
                            </Reminder>
